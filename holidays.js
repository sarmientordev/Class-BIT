/* ══════════════════════════════════════════════════
   COLOMBIA HOLIDAYS — Festivos de Colombia
   Regidos por: Ley Emiliani (Ley 51 de 1983) y feriados
   basados en Semana Santa (fecha móvil).
   ══════════════════════════════════════════════════ */
...
function moveToMonday(date) {
  ...
  const add = (8 - day) % 7; // días para el próximo lunes
...
const FIXED = [
  ...
  { m: 6, d: 20, name: 'Día de la Independencia' },
  { m: 7, d: 7, name: 'Batalla de Boyacá' },
...
const EMILIANI = [
  ...
  { m: 10, d: 1, name: 'Día de Todos los Santos' },
  { m: 10, d: 11, name: 'Independencia de Cartagena' },
  { m: 11, d: 8, name: 'Día de la Inmaculada Concepción' },
];
...
function easterBased(year) {
  ...
  return [
    ...
    { date: moveToMonday(addDays(easter, 40)), name: 'Día de la Ascensión del Señor' },
    { date: moveToMonday(addDays(easter, 60)), name: 'Corpus Christi' },
    { date: moveToMonday(addDays(easter, 68)), name: 'Sagrado Corazón de Jesús' },
  ];
}
...
// Próximos festivos a partir de la fecha dada (incluye el de hoy si existe)
